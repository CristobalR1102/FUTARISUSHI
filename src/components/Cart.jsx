export default function Cart({ cart, onCheckout }) {
  ...
  return (
    <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md z-50 border-t overflow-hidden" style={{ background: "#0a0a0a", borderColor: "#2a2a2a", maxHeight: "25vh" }}>
